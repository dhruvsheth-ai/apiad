# Taken from <https://github.com/svpino/twitter-threading> and modified
# Copyright (c) 2020 - Santiago Valdarrama (@svpino)
...
def load(filename):
    with open(filename) as file:
        thread = yaml.load(file, Loader=yaml.SafeLoader)
